...
<f:view>
  ...
  <body style="margin:0;padding:0;height: 100%;overflow: hidden;" id="bgcolor-inner"
        ...
        onload="resetGlobalEventFlag();try{self.focus();}catch(e){};setAppType(false);setupModalLayer();initWindowOKCancel();setupTaskContainerEvents();checkForLockTimeout();setLIMSActivityTimer()"
  ...
  <div id="ec_safari_event_wrapper_div" style="width:100%;height:100%">
    <e:form id="mf" onsubmit="return false" style="display:block;margin:0;padding:0;width:100%;height:100%">
      ...
      <div id="container">
       ...
       <!-- End Right Box-->
        <lw:statuspane id="status" styleClass="homeStatusBar" value="#{statusBoxBean.value}"></lw:statuspane>
  ...
  <script type="text/javascript" language="JavaScript">
    ...
    // It is delcared in labware.js and initialise here
