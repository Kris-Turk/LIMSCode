...
<f:view>
  ...
  <body style="margin:0;height: 100%;overflow: hidden;"
        ...
        onload="resetGlobalEventFlag();try{self.focus();}catch(e){};setAppType('true');checkForLockTimeout();setupModalLayer();initWindowOKCancel();registerTaskWindow();setupTaskContainerEvents();setLIMSActivityTimer();"
  ...
  <div id="ec_safari_event_wrapper_div" style="width:100%;height:100%">
    <e:form id="mf" onsubmit="return false">
      ...
      <div class="top-bar">
        <div class='main-toolbar-popup-button' style="display:none;"></div>
        <div class="main-toolbar-popup" style="display:none;">
          <lw:mainToolbar id="mainToolbar" ajax="true" rendered="false"/>
        </div>
        ...
        <div class="search" style="display:none;">
          ...
          <e:button type="button" value="" styleClass="search-button" rendered="false"/>
        </div>
      </div>
