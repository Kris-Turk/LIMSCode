...
<e:define id="mainPane">
  <script type="text/javascript" language="JavaScript">
    window.document.title = "LabWare Admin Console -- Invoke Routine";
  </script>
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td align="center" valign="top" width="100%">
                <table border="0" cellspacing="0" cellpadding="0" width="100%" bgcolor="adb6bd">
                    <tr>
                        <td align="center">
                          <e:div id="invokeRtnMsgDiv" ajax="true">
                            <h:messages infoClass="admin_message" id="rtnMsg"
                    ...
                    <tr>
                        <td width="100%" align="center" valign="middle"
                            ...
                            Test for the Web Routine:
                            <h:outputText id="fxName" value="#{invokeRoutineBean.routineName}"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="left"
                            style="background-color: #ffffff; font-family: verdana; font-size: 14px;">
                            <b>Web Routine Description: </b>
                            <h:outputText id="fxDescription"
                                          value="#{invokeRoutineBean.routineDescription}"/>
                            <br>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="center" bgcolor="#eff5f5">
                            ...
                            <e:fieldLayout id="routineLayout" binding="#{invokeRoutineBean.curentRoutineFieldLayout}"
                            ...
                            <e:button id="invokeRtnButton" onclick="#{invokeRoutineBean.submitForm}"
                                                value="Invoke Routine" ajax="true"/>
                        </td>
                    </tr>
                </table>
                <br><br>
